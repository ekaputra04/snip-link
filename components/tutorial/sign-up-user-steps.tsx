    ...
    <ol className="flex flex-col gap-6">
      <TutorialStep title="Set up redirect urls">
        ...
        <p className="mt-4">
          ...
          <span className="relative bg-muted px-[0.3rem] py-[0.2rem] border rounded font-medium font-mono text-secondary-foreground text-xs">
        ...
        <Link
          ...
          target="_blank"
          className="flex items-center gap-1 mt-4 text-primary/50 text-sm hover:text-primary"
        >
